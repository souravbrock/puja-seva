...
import { apiGet, inr, fmtDateTime, absUrl } from '../lib/format';
            ...
            return (
              <Card key={u.id} className="overflow-hidden">
                <div className="relative">
                  <img src={absUrl(u.image_url) || '/images/havan.svg'} alt={u.title} className="w-full h-48 sm:h-60 object-cover" />
